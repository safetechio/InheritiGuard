...
The URL Filtering Protection feature of InheritiGuard ensures that your browser only communicates with trusted Inheriti-related domains and their essential dependencies. This means that even if a malicious script tries to send your data somewhere else, it will be blocked.
...
The Block Sensitive APIs feature of InheritiGuard proactively protects your privacy by monitoring and restricting access to these sensitive features. If a website tries to access your location, camera, microphone, clipboard, or other potentially risky functions, InheritiGuard will block the request and notify you.
